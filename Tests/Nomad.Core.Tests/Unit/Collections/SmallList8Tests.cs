...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class SmallList8Tests
    {
        [Test]
        public void SmallList8_TryAddIndexerAndClear_RespectFixedCapacity()
        {
            var list = new SmallList8<int>();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(list[7], Is.EqualTo(7));
            }
