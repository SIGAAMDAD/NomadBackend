...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet256DenseCacheTests
    {
        [Test]
        public void PackedBitSet256DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet256DenseCache(513);
            int highBit = 256 + 1;
            int highPage = 1;
