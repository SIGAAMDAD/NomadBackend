...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet1024DenseCacheTests
    {
        [Test]
        public void PackedBitSet1024DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet1024DenseCache(2049);
            int highBit = 1024 + 1;
            int highPage = 1;
