...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet256Tests
    {
        [Test]
        public void PackedBitSet256_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet256();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(255), Is.True);
