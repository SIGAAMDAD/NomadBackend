...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet16SparseCacheTests
    {
        [Test]
        public void PackedBitSet16SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet16SparseCache(1);
            int highBit = 32 + 3;
            int expectedPage = 2;
