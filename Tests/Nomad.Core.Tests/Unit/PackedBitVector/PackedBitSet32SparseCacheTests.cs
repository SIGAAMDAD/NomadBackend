...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet32SparseCacheTests
    {
        [Test]
        public void PackedBitSet32SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet32SparseCache(1);
            int highBit = 64 + 3;
            int expectedPage = 2;
