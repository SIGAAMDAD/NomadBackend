...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet8DenseCacheTests
    {
        [Test]
        public void PackedBitSet8DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet8DenseCache(17);
            int highBit = 8 + 1;
            int highPage = 1;
