...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet128SparseCacheTests
    {
        [Test]
        public void PackedBitSet128SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet128SparseCache(1);
            int highBit = 256 + 3;
            int expectedPage = 2;
