...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet512DenseCacheTests
    {
        [Test]
        public void PackedBitSet512DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet512DenseCache(1025);
            int highBit = 512 + 1;
            int highPage = 1;
