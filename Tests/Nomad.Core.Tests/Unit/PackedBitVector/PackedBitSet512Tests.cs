...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet512Tests
    {
        [Test]
        public void PackedBitSet512_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet512();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(511), Is.True);
