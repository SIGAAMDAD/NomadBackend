...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet64SparseCacheTests
    {
        [Test]
        public void PackedBitSet64SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet64SparseCache(1);
            int highBit = 128 + 3;
            int expectedPage = 2;
