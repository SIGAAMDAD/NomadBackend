...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet64Tests
    {
        [Test]
        public void PackedBitSet64_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet64();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(63), Is.True);
            ...
            Assert.That(bits.IsEmpty, Is.True);
                    ...
                    bits.Raw0 = ulong.MaxValue;
                    bits.Sanitize();
                    Assert.That(bits.Raw0, Is.EqualTo(ulong.MaxValue));
