...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet256SparseCacheTests
    {
        [Test]
        public void PackedBitSet256SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet256SparseCache(1);
            int highBit = 512 + 3;
            int expectedPage = 2;
