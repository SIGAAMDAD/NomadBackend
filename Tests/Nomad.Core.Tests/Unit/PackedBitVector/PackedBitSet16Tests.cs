...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet16Tests
    {
        [Test]
        public void PackedBitSet16_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet16();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(15), Is.True);
            ...
            Assert.That(bits.IsEmpty, Is.True);
                    ...
                    bits.Sanitize();
                    Assert.That(bits.Raw0, Is.EqualTo(((1UL << 16) - 1UL)));
