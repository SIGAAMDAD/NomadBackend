...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet16DenseCacheTests
    {
        [Test]
        public void PackedBitSet16DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet16DenseCache(33);
            int highBit = 16 + 1;
            int highPage = 1;
