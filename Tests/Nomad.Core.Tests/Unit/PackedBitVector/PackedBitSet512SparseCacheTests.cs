...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet512SparseCacheTests
    {
        [Test]
        public void PackedBitSet512SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet512SparseCache(1);
            int highBit = 1024 + 3;
            int expectedPage = 2;
