...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet1024Tests
    {
        [Test]
        public void PackedBitSet1024_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet1024();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(1023), Is.True);
