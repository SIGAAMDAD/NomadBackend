...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet8Tests
    {
        [Test]
        public void PackedBitSet8_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(7), Is.True);
            ...
            Assert.That(bits.IsEmpty, Is.True);
                    ...
                    bits.Sanitize();
                    Assert.That(bits.Raw0, Is.EqualTo(((1UL << 8) - 1UL)));
