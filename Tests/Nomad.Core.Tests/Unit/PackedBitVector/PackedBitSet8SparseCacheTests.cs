...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet8SparseCacheTests
    {
        [Test]
        public void PackedBitSet8SparseCache_SetUnsetToggleDirtyAndClear_UpdateSparsePages()
        {
            var cache = new PackedBitSet8SparseCache(1);
            int highBit = 16 + 3;
            int expectedPage = 2;
