...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet32DenseCacheTests
    {
        [Test]
        public void PackedBitSet32DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet32DenseCache(65);
            int highBit = 32 + 1;
            int highPage = 1;
