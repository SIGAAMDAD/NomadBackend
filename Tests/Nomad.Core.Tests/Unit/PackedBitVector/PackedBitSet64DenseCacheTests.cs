...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet64DenseCacheTests
    {
        [Test]
        public void PackedBitSet64DenseCache_SetUnsetToggleDirtyAndClear_UpdatePages()
        {
            var cache = new PackedBitSet64DenseCache(129);
            int highBit = 64 + 1;
            int highPage = 1;
