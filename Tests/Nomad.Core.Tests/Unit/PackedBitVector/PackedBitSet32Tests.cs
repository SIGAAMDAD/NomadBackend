...
namespace Nomad.Core.Tests
{
    ...
    [Category("Unit")]
    [Category("UnitTests")]
    public sealed class PackedBitSet32Tests
    {
        [Test]
        public void PackedBitSet32_SetUnsetToggleSetAllClearAndSanitize_UpdateExpectedBits()
        {
            var bits = new PackedBitSet32();
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(bits.Get(31), Is.True);
            ...
            Assert.That(bits.IsEmpty, Is.True);
                    ...
                    bits.Sanitize();
                    Assert.That(bits.Raw0, Is.EqualTo(((1UL << 32) - 1UL)));
