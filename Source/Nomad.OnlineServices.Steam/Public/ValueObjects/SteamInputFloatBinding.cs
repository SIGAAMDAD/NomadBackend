...
{
    public sealed record SteamInputFloatBinding
    {
        public InternString ActionId { get; }
        public string SteamActionName { get; }
        public SteamFloatSourceChannel Channel { get; }
        public float DeadZone { get; }

        public SteamInputFloatBinding(InternString actionId, string steamActionName, SteamFloatSourceChannel channel, float deadZone = 0.15f)
        {
            ActionId = actionId;
