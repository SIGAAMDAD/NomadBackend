...
{
    public sealed class PooledBinaryHeap<T> : IDisposable
    {
        private T[]? _items;
        ...
        public PooledBinaryHeap(int initialCapacity = 32, IComparer<T>? comparer = null, ArrayPool<T>? pool = null)
        {
        ...
        private T[] Items { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { if (_items == null) { throw new ObjectDisposedException(nameof(PooledBinaryHeap<T>)); } return _items; } }
    }
}
