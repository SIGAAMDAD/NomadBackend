...
{
    public readonly struct WeightedEdge<TWeight>
    {
        public readonly int To;
        public readonly TWeight Weight;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WeightedEdge(int to, TWeight weight)
        {
            To = to;
            Weight = weight;
        }
    ...
    public sealed class WeightedCompactGraph<TWeight>
    {
        private readonly int[] _offsets;
        private readonly WeightedEdge<TWeight>[] _edges;
        ...
        public WeightedCompactGraph(int[] offsets, WeightedEdge<TWeight>[] edges)
        {
            _offsets = offsets ?? throw new ArgumentNullException(nameof(offsets));
            _edges = edges ?? throw new ArgumentNullException(nameof(edges));
        }

        public ReadOnlySpan<WeightedEdge<TWeight>> GetNeighbors(int node)
        {
