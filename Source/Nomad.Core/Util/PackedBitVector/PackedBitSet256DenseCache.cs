...
{
    public sealed class PackedBitSet256DenseCache
    {
        private const int PageShift = 8;
        private const int PageMask = 255;

        private readonly PackedBitSet256[] _pages;
        ...
        public PackedBitSet256DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet256[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet256 GetPageByIndex(int pageIndex)
        {
