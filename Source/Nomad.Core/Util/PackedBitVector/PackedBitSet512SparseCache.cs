...
{
    public sealed class PackedBitSet512SparseCache
    {
        ...
        private PackedBitSet512[] _pages;
        private bool[] _dirty;
        private int _count;
        ...
        public PackedBitSet512SparseCache(int initialPageCapacity = 16)
        {
            ...
            _pages = new PackedBitSet512[initialPageCapacity];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet512 GetPageBySlot(int slot)
        {
            Debug.Assert((uint)slot < (uint)_count);
