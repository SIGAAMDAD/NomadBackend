...
{
    public sealed class PackedBitSet1024DenseCache
    {
        private const int PageShift = 10;
        private const int PageMask = 1023;

        private readonly PackedBitSet1024[] _pages;
        ...
        public PackedBitSet1024DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet1024[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet1024 GetPageByIndex(int pageIndex)
        {
