...
{
    public sealed class PackedBitSet128DenseCache
    {
        private const int PageShift = 7;
        private const int PageMask = 127;

        private readonly PackedBitSet128[] _pages;
        ...
        public PackedBitSet128DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet128[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet128 GetPageByIndex(int pageIndex)
        {
