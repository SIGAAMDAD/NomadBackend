...
{
    public sealed class PackedBitSet64DenseCache
    {
        private const int PageShift = 6;
        private const int PageMask = 63;

        private readonly PackedBitSet64[] _pages;
        ...
        public PackedBitSet64DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet64[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet64 GetPageByIndex(int pageIndex)
        {
