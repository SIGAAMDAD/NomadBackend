...
{
    public sealed class PackedBitSet16DenseCache
    {
        private const int PageShift = 4;
        private const int PageMask = 15;

        private readonly PackedBitSet16[] _pages;
        ...
        public PackedBitSet16DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet16[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet16 GetPageByIndex(int pageIndex)
        {
