...
{
    public sealed class PackedBitSet32DenseCache
    {
        private const int PageShift = 5;
        private const int PageMask = 31;

        private readonly PackedBitSet32[] _pages;
        ...
        public PackedBitSet32DenseCache(int maxBitId)
        {
            if (maxBitId < 0)
            {
            ...
            _pages = new PackedBitSet32[pageCount];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet32 GetPageByIndex(int pageIndex)
        {
