...
{
    public sealed class PackedBitSet32SparseCache
    {
        private const int PageShift = 5;
        private const int PageMask = 31;

        private readonly Dictionary<int, int> _slotsByPage;
        private int[] _pageKeys;
        private PackedBitSet32[] _pages;
        private bool[] _dirty;
        private int _count;
        ...
        public PackedBitSet32SparseCache(int initialPageCapacity = 16)
        {
            ...
            _pages = new PackedBitSet32[initialPageCapacity];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet32 GetPageBySlot(int slot)
        {
            Debug.Assert((uint)slot < (uint)_count);
