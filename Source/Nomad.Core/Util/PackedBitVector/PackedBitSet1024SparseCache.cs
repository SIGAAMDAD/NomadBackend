...
{
    public sealed class PackedBitSet1024SparseCache
    {
        private const int PageShift = 10;
        private const int PageMask = 1023;

        private readonly Dictionary<int, int> _slotsByPage;
        private int[] _pageKeys;
        private PackedBitSet1024[] _pages;
        private bool[] _dirty;
        private int _count;
        ...
        public PackedBitSet1024SparseCache(int initialPageCapacity = 16)
        {
            ...
            _pages = new PackedBitSet1024[initialPageCapacity];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet1024 GetPageBySlot(int slot)
        {
            Debug.Assert((uint)slot < (uint)_count);
