...
{
    public sealed class PackedBitSet16SparseCache
    {
        private const int PageShift = 4;
        private const int PageMask = 15;

        private readonly Dictionary<int, int> _slotsByPage;
        private int[] _pageKeys;
        private PackedBitSet16[] _pages;
        private bool[] _dirty;
        private int _count;
        ...
        public PackedBitSet16SparseCache(int initialPageCapacity = 16)
        {
            ...
            _pages = new PackedBitSet16[initialPageCapacity];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref PackedBitSet16 GetPageBySlot(int slot)
        {
            Debug.Assert((uint)slot < (uint)_count);
