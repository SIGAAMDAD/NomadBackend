	...
	*/
	...
	public sealed class GameEventBus : IGameEventBusService {
		...
		*/
		...
		public void Subscribe<TArgs>( object subscriber, IGameEvent<TArgs> @event, IGameEvent<TArgs>.EventCallback callback ) where TArgs : struct {
		}

		public void SubscribeAsync<TArgs>( object subscriber, IGameEvent<TArgs> @event, IGameEvent<TArgs>.AsyncCallback asyncCallback ) where TArgs : struct {
		}

		public void Unsubscribe<TArgs>( object subscriber, IGameEvent<TArgs> @event, IGameEvent<TArgs>.EventCallback callback ) where TArgs : struct {
		}

		public void UnsubscribeAsync<TArgs>( object subscriber, IGameEvent<TArgs> @event, IGameEvent<TArgs>.AsyncCallback asyncCallback ) where TArgs : struct {
		}
