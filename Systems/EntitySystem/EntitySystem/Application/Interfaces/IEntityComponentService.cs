...
namespace NomadCore.Systems.EntitySystem.Application.Interfaces {
	public interface IEntityComponentService : IGameService {
		public IGameEntity CreateEntity( InternString name, Area2D area, Sprite2D sprite );
		public IGameEntity CreateEntity( InternString name, CharacterBody2D body, AnimatedSprite2D animatedSprite );
		public void DestroyEntity( IGameEntity entity, bool immediate = false );
		public IGameEntity FindEntityByName( InternString name );
		...
		public void AddComponents( IGameEntity entity, ReadOnlySpan<IComponent> components );
